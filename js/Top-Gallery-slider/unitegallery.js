...
function UniteGalleryMain(){
	...
	if(!flagCarousel){
		...
		var g_options = {				
			...
			gallery_theme:"grid",					//default,compact,grid,slider - select your desired theme from the list of themes.
			...
			gallery_play_interval: 8000,				//play interval of the slideshow
			...
			gallery_shuffle:true,						//randomise position of items at start.
		...
		var g_options = {				
			...
			gallery_theme:"slider",					//default,compact,grid,slider - select your desired theme from the list of themes.
			gallery_skin:"default",						//default, alexis etc... - the global skin of the gallery. Will change all gallery items by default.
